...
#ifdef _MSC_VER
	#define SPV_REFLECT_API_EXPORT __declspec(dllexport)
	#define SPV_REFLECT_API_IMPORT __declspec(dllimport)
#else
	#define SPV_REFLECT_API_EXPORT __attribute__((visibility("default")))
	#define SPV_REFLECT_API_IMPORT
#endif

#ifdef SPV_REFLECT_EXPORTS
	#define SPV_REFLECT_API SPV_REFLECT_API_EXPORT
#else
	#define SPV_REFLECT_API SPV_REFLECT_API_IMPORT
#endif
...
SPV_REFLECT_API SpvReflectResult spvReflectGetShaderModule(
  size_t                   size,
  const void*              p_code,
  SpvReflectShaderModule*  p_module
);
...
SPV_REFLECT_API SpvReflectResult spvReflectEnumeratePushConstants(
  const SpvReflectShaderModule* p_module,
  uint32_t*                     p_count,
  SpvReflectBlockVariable**     pp_blocks
);
...
SPV_REFLECT_API const SpvReflectInterfaceVariable* spvReflectGetInputVariable(
  const SpvReflectShaderModule* p_module,
  uint32_t                      location,
  SpvReflectResult*             p_result
);
...
SPV_REFLECT_API const SpvReflectInterfaceVariable* spvReflectGetOutputVariable(
  const SpvReflectShaderModule*  p_module,
  uint32_t                       location,
  SpvReflectResult*              p_result
);
...
SPV_REFLECT_API const SpvReflectBlockVariable* spvReflectGetPushConstant(
  const SpvReflectShaderModule*  p_module,
  uint32_t                       index,
  SpvReflectResult*              p_result
);
...
SPV_REFLECT_API SpvReflectResult spvReflectChangeDescriptorBindingNumber(
  SpvReflectShaderModule*            p_module,
